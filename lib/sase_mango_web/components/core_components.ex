defmodule SaseMangoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SaseMangoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SaseMangoWeb.Gettext, "errors", msg, opts)
    end
  end
