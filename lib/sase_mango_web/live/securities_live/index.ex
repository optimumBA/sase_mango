defmodule SaseMangoWeb.SecuritiesLive.Index do
  ...
  defp assign_sort_options(socket, params) do
    ...
    new_sort_order = HandleTable.set_sort_order(params["sort_order"])
  ...
  def handle_info({:url_update, options}, socket) do
    url_params = HandleTable.merge_url_params(socket, options)
  ...
  def handle_event("sort_column", %{"col_name" => name} = _params, socket) do
    ...
    url_params = HandleTable.merge_url_params(socket, sort_options)
    path = Routes.securities_index_path(socket, socket.assigns.live_action, url_params)
  ...
  def handle_event("clear_form", _params, socket) do
    url_params = HandleTable.merge_url_params(socket, %{q: nil})
    path = Routes.securities_index_path(socket, socket.assigns.live_action, url_params)
